...
--
-- Servidor: localhost
-- Tempo de Geração: 12/12/2018 às 12h10min
...
('def', 'planader', 'cadastrodemanda', 'nomeOrg', 1, NULL, 'NO', 'varchar', 50, 200, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastrodemanda', 'demanda', 2, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastrodemanda', 'atendimento', 3, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastrodemanda', 'previsao', 4, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'nome', 2, NULL, 'NO', 'varchar', 60, 180, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'site', 3, NULL, 'NO', 'varchar', 60, 180, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'email', 4, NULL, 'NO', 'varchar', 60, 180, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(60)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'cnpj', 5, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'endereco', 6, NULL, 'NO', 'varchar', 60, 180, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'cidade', 7, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'telefone', 8, NULL, 'NO', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'ramo', 9, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'responsavel', 10, NULL, 'NO', 'varchar', 35, 105, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(35)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'senha', 11, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'nivel', 12, '1', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'ativo', 13, '1', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'planader', 'cadastroinstituicao', 'cadastro', 14, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'contato', 'nome', 1, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'contato', 'mensagem', 2, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'nomeemp', 1, NULL, 'NO', 'varchar', 30, 120, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'cnpj', 2, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'cidade', 3, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'telefone', 4, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'email1', 5, NULL, 'NO', 'varchar', 40, 160, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'senha', 6, NULL, 'NO', 'varchar', 40, 160, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'atuacao', 7, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadosempresa', 'descricao', 8, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'matricula', 1, NULL, 'NO', 'varchar', 25, 100, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'nome', 2, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'dataNasc', 3, NULL, 'NO', 'varchar', 12, 48, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'idade', 4, NULL, 'NO', 'varchar', 3, 12, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(3)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'cpf', 5, NULL, 'NO', 'varchar', 15, 60, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'gene', 6, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'estCivil', 7, NULL, 'NO', 'varchar', 30, 120, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'natu', 8, NULL, 'NO', 'varchar', 30, 120, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'email', 9, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'senha', 10, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'cel', 11, NULL, 'NO', 'varchar', 10, 40, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'cep', 12, NULL, 'NO', 'varchar', 9, 36, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(9)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'rua', 13, NULL, 'NO', 'varchar', 50, 200, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'bairro', 14, NULL, 'NO', 'varchar', 30, 120, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'cidade', 15, NULL, 'NO', 'varchar', 50, 200, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'uf', 16, NULL, 'NO', 'varchar', 2, 8, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(2)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'curso', 17, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'anoIng', 18, NULL, 'NO', 'varchar', 4, 16, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'anoEgre', 19, NULL, 'NO', 'varchar', 4, 16, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'auxilio', 20, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'bolsa', 21, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'escola', 22, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'escolha', 23, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'area', 24, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'emp', 25, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'carg', 26, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'cidadeA', 27, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'trab', 28, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'atual', 29, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'salario', 30, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'motivo', 31, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'conte', 32, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'projetos', 33, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'dificuldades', 34, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'curriculo', 35, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'mercado', 36, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'prof', 37, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'nota', 38, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'compartilhar', 39, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'coments', 40, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'cursoForm', 41, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'dadospessoais', 'depoimento', 42, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'vaga', 'nomeemp', 1, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'vaga', 'atuacao', 2, NULL, 'NO', 'varchar', 80, 320, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'tcc', 'vaga', 'descricao', 3, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '1747'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '1681'),
('INNODB_BUFFER_POOL_PAGES_DATA', '194'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '913'),
('INNODB_BUFFER_POOL_READS', '195'),
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\DESKTOP-741DBV0.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\DESKTOP-741DBV0.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\DESKTOP-741DBV0-slow.log'),
('CHARACTER_SET_SYSTEM', 'utf8'),
('SYSTEM_TIME_ZONE', 'Hor'),
...
('def', 'planader', 'PRIMARY', 'def', 'planader', 'cadastrodemanda', 'nomeOrg', 1, NULL, NULL, NULL, NULL),
('def', 'planader', 'PRIMARY', 'def', 'planader', 'cadastroinstituicao', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'planader', 'email', 'def', 'planader', 'cadastroinstituicao', 'email', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-12-12 12:10:25', '2018-12-12 12:10:25', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2018-12-12 12:10:25', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', '2011-12-16 21:27:59', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1028, 9, 9252, 2533274790395903, 19456, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 867, 440716, 281474976710655, 20480, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', '2011-12-16 21:27:59', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, NULL, '', '', NULL),
...
('def', 'planader', 'cadastrodemanda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2018-12-01 19:17:50', NULL, NULL, NULL, '', '', NULL),
('def', 'planader', 'cadastroinstituicao', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 0, '2018-12-01 19:17:51', NULL, NULL, NULL, '', '', NULL),
('def', 'tcc', 'contato', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-12-03 21:49:46', NULL, NULL, NULL, '', '', NULL),
('def', 'tcc', 'dadosempresa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2018-12-03 21:49:46', NULL, NULL, NULL, '', '', NULL),
('def', 'tcc', 'dadospessoais', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2018-12-03 21:49:46', NULL, NULL, NULL, '', '', NULL),
('def', 'tcc', 'vaga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2018-12-03 21:49:46', NULL, NULL, NULL, '', '', NULL);
...
(6, 'root', 'localhost:53536', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'planader', 'utf8', 'utf8_general_ci', NULL),
('def', 'tcc', 'utf8mb4', 'utf8mb4_unicode_ci', NULL),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2261'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2344'),
('INNODB_BUFFER_POOL_PAGES_DATA', '197'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '0'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1126'),
('INNODB_BUFFER_POOL_READS', '198'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '0'),
('INNODB_DATA_FSYNCS', '3'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '5427200'),
('INNODB_DATA_READS', '208'),
('INNODB_DATA_WRITES', '3'),
('INNODB_DATA_WRITTEN', '1536'),
('INNODB_DBLWR_PAGES_WRITTEN', '0'),
('INNODB_DBLWR_WRITES', '0'),
...
('def', 'planader', 'cadastrodemanda', 0, 'planader', 'PRIMARY', 1, 'nomeOrg', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'planader', 'cadastroinstituicao', 0, 'planader', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'planader', 'cadastroinstituicao', 0, 'planader', 'email', 1, 'email', 'A', 3, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-12-12 12:10:26', '2018-12-12 12:10:26', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2018-12-12 12:10:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', '2011-12-16 21:27:59', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1028, 9, 9252, 2533274790395903, 19456, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 867, 440716, 281474976710655, 20480, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', '2011-12-16 21:27:59', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 11:56:42', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'planader', 'cadastrodemanda', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 9437184, NULL, '2018-12-01 19:17:50', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'planader', 'cadastroinstituicao', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 9437184, 10, '2018-12-01 19:17:51', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'tcc', 'contato', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, NULL, '2018-12-03 21:49:46', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'tcc', 'dadosempresa', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 9437184, NULL, '2018-12-03 21:49:46', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'tcc', 'dadospessoais', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 9437184, NULL, '2018-12-03 21:49:46', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'tcc', 'vaga', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 9437184, NULL, '2018-12-03 21:49:46', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', '');
...
('def', 'planader', 'PRIMARY', 'planader', 'cadastrodemanda', 'PRIMARY KEY'),
('def', 'planader', 'PRIMARY', 'planader', 'cadastroinstituicao', 'PRIMARY KEY'),
('def', 'planader', 'email', 'planader', 'cadastroinstituicao', 'UNIQUE');
...
--
-- Banco de Dados: `planader`
--
CREATE DATABASE `planader` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `planader`;

-- --------------------------------------------------------

--
-- Estrutura da tabela `cadastrodemanda`
--

CREATE TABLE IF NOT EXISTS `cadastrodemanda` (
  `nomeOrg` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `demanda` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `atendimento` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `previsao` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`nomeOrg`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Extraindo dados da tabela `cadastrodemanda`
--

INSERT INTO `cadastrodemanda` (`nomeOrg`, `demanda`, `atendimento`, `previsao`) VALUES
(' Lucas Ltda ', 'a', 'Via um curso in-company', 'De 3 a 6 meses');
...
CREATE TABLE IF NOT EXISTS `cadastroinstituicao` (
...
--
-- Extraindo dados da tabela `cadastroinstituicao`
--

INSERT INTO `cadastroinstituicao` (`id`, `nome`, `site`, `email`, `cnpj`, `endereco`, `cidade`, `telefone`, `ramo`, `responsavel`, `senha`, `nivel`, `ativo`, `cadastro`) VALUES
(2, 'Lucas Empresa', 'lucas.com.br', 'lucas2brandalise@gmail.com', '89360146000151', 'Rua Aratiba', 'Erechim', '54997016953', 'comercio', 'Lucas Brandalise', '10c25665e49274c39b8e8f7ad6e2a3d0b0bc5052', 1, 1, '2018-11-01 14:43:20'),
(8, 'Lucas Avaliador', 'LA.com.br', 'la@gmail.com', '000', 'Rua Gaurama', 'Erechim', '54997016953', 'prestadora de servic', 'Brandalise', '10c25665e49274c39b8e8f7ad6e2a3d0b0bc5052', 2, 1, '2018-12-01 19:00:13'),
(9, 'Lucas Externo', 'LE.com.br', 'le@gmail.com', '000', 'Rua China', 'Erechim', '54999863188', 'educacao', 'Branda', '10c25665e49274c39b8e8f7ad6e2a3d0b0bc5052', 3, 1, '2018-12-01 19:03:18');
--
-- Banco de Dados: `tcc`
--
CREATE DATABASE `tcc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `tcc`;
...
CREATE TABLE IF NOT EXISTS `dadosempresa` (
  `nomeemp` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `atuacao` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `dadosempresa` (`nomeemp`, `cnpj`, `cidade`, `telefone`, `email1`, `senha`, `atuacao`, `descricao`) VALUES
('Rampi Autopeças', '99.999.999/9999-99', 'Erechim', '991338899', 'rampiautopecas@gmail.com', 'kkk', 'Engenharia Mecânica', 'Carga horário 8 horas, experiências com peças.'),
('Lucas Ltda', '00000', 'Gaurama', '999863188', 'lucas.brandalise.98@gmail.com', 'lucas', 'Técnico Concomitante em Informática', 'aaaaaaaaa');
...
CREATE TABLE IF NOT EXISTS `dadospessoais` (
  `matricula` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nome` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dataNasc` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `idade` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cpf` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gene` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estCivil` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `natu` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `senha` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cel` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `curso` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `anoIng` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `anoEgre` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `auxilio` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bolsa` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `escola` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `escolha` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `area` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emp` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `carg` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cidadeA` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trab` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `atual` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `salario` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `motivo` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `conte` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `projetos` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dificuldades` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `curriculo` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mercado` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prof` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nota` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `compartilhar` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `coments` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cursoForm` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `depoimento` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `dadospessoais` (`matricula`, `nome`, `dataNasc`, `idade`, `cpf`, `gene`, `estCivil`, `natu`, `email`, `senha`, `cel`, `cep`, `rua`, `bairro`, `cidade`, `uf`, `curso`, `anoIng`, `anoEgre`, `auxilio`, `bolsa`, `escola`, `escolha`, `area`, `emp`, `carg`, `cidadeA`, `trab`, `atual`, `salario`, `motivo`, `conte`, `projetos`, `dificuldades`, `curriculo`, `mercado`, `prof`, `nota`, `compartilhar`, `coments`, `cursoForm`, `depoimento`) VALUES
('4370018', 'Luana Milena Bueno da Cás', '05/03/2001', '17', '036.835.600-02', 'Feminino', 'Solteiro(a)', 'Selecione', 'luanabuenodacaa@gmail.com', 'luana', '991338899', '99700-182', 'Rua José do Patriocinio', 'Centro', 'Erechim', 'RS', 'Técnico Concomitante em Informática', '2016', '2018', 'Auxílio Permanência', 'Bolsa de Extensão', 'Todo em escola pública', 'Qualidade/Reputação', 'Sim', 'System', 'Estagiaria', 'Erechim', 'Sim', 'Assalariado com carteira assinada', 'Até um salário mínimo', 'Outros', 'Sim', '1', 'Falta de experiência', 'Sim', 'Sim', 'Insatisfeito', '1', 'Sim', 'Mais visitações a empresas.', 'Cursos para egressos.', 'Indico o curso.'),
('000000', 'Lucas Luiz Brandalise', '21122000', '17', '02594904074', 'Masculino', 'Solteiro(a)', 'Brasileira', 'lucas2brandalise@gmail.com', 'lucas', '997016953', '99830000', 'Linha Cinco', 'Interior', 'Gaurama', 'RS', 'Técnico Concomitante em Informática', '2016', '2018', 'Auxílio Permanência', 'Bolsa de Pesquisa', 'Todo em escola pública', 'Qualidade/Reputação', 'Sim', 'aaaaaaaa', 'aaaaaaa', 'aaaaaaaaaaa', 'Sim', 'Assalariado com carteira assinada', 'Entre oito e dez salários mínimos', 'Exigência de experiência profissional', 'Sim', '1', 'Falta de experiência', 'Sim', 'Sim', 'Insatisfeito', '1', 'Sim', 'aaaaaa', 'aaaaaaaaa', 'aaaaaaaa');
...
CREATE TABLE IF NOT EXISTS `vaga` (
  `nomeemp` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `atuacao` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descricao` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `vaga` (`nomeemp`, `atuacao`, `descricao`) VALUES
('Luana Ltda', 'Técnico Concomitante em Informática', '8 horas diárias, experiencia com programação em PHP, férias remuneradas.');
--
-- Banco de Dados: `test`
--
