...
<body>
        ...
        <div id="container">
            <div id="central">
                <div id="fundo" align="center">
                    <h3>Demandas cadastradas na PLATAFORMA no nome de <b><?php echo $_SESSION['UsuarioNome']; ?></b></h3>
                    <hr>
                    <?php
    ...
    <hr>
    <center><a href="organizacoes.php"><input type="submit" title="Voltar" name="voltar" value="Voltar" /></a></center>
