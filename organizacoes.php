...
-->
        ...
        <section>
            ...
            <div class="row">
				...
				while($escrever=mysqli_fetch_array($res)){
					echo "<tr>";
						...
						echo "<tr>";
						echo "<td>Ramo: </td>\n";
						echo "<td>".$escrever['ramo']."</td>";
						echo "</tr>";
                    
                        echo "<tr>";
						echo "<td>Responsável: </td>\n";
						echo "<td>".$escrever['responsavel']."</td>";
						echo "</tr>";
					echo "</tr>";
				}
            ...
            <center>
                <h3>Já possui uma demanda cadastrada? Consulte-a aqui!</h3>
            </center>

            <center><label><a href="buscausuarios2.php"><input type="button" title="Consultar Demanda" name="consultar_demanda" value="Consultar Demanda" /></a></label></center>
